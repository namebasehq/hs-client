...
class WalletClient extends Client {
  ...
  /**
   * Get wallet coin distribution.
   * @param {String} account
   * @param {Number} bucketExponent
   * @returns {Promise}
   */

  getCoinDistribution(id, account, bucketExponent) {
    return this.get(`/wallet/${id}/coin-distribution`, {
      account,
      bucketExponent
    });
  }
  ...
  createOpen(id, options) {
   ...
   /**
   * Create batched open transaction.
   * @param {String} id
   * @param {Object} options
   * @returns {Promise}
   */

  createBatchOpen(id, options) {
    return this.post(`/wallet/${id}/batch/open`, options);
  }
  ...
  /**
   * Create batched bid transaction.
   * @param {String} id
   * @param {Object} options
   * @returns {Promise}
   */

  createBatchBid(id, options) {
    return this.post(`/wallet/${id}/batch/bid`, options);
  }
  ...
  createUpdate(id, options) {
   ...
   /**
   * Create batched finish(redeem or register) transaction.
   * @param {String} id
   * @param {Object} options
   * @returns {Promise}
   */

  createBatchFinish(id, options) {
    return this.post(`/wallet/${id}/batch/finish`, options);
  }
  ...
  createBatchTransfer(id, options) {
    return this.post(`/wallet/${id}/batch/transfer`, options);
  }
  ...
  /**
   * Create batch finalize transaction.
   * @param {String} id
   * @param {Object} options
   * @returns {Promise}
   */

  createBatchFinalize(id, options) {
    return this.post(`/wallet/${id}/batch/finalize`, options);
  }
  ...
  getAddress(id, account, index) {
    return this.get(`/wallet/${id}/address`, { account, index });
  }
  ...
  getChange(id, account, index) {
    return this.get(`/wallet/${id}/change`, { account, index });
  }
...
class Wallet extends EventEmitter {
  ...
  getCoinDistribution(account, bucketExponent) {
    return this.client.getCoinDistribution(this.id, account, bucketExponent);
  }
  ...
  createBatchOpen(options) {
    return this.client.createBatchOpen(this.id, options);
  }
  ...
  createBatchBid(options) {
    return this.client.createBatchBid(this.id, options);
  }
  ...
  /**
   * Create batch finish (redeem or register) transaction.
   * @param {Object} options
   * @returns {Promise}
   */

  createBatchFinish(options) {
    return this.client.createBatchFinish(this.id, options);
  }
  ...
  createBatchTransfer(options) {
    return this.client.createBatchTransfer(this.id, options);
  }
  ...
  createBatchFinalize(options) {
    return this.client.createBatchFinalize(this.id, options);
  }
  ...
  getAddress(account, index) {
    return this.client.getAddress(this.id, account, index);
  }
  ...
  getChange(account, index) {
    return this.client.getChange(this.id, account, index);
  }
